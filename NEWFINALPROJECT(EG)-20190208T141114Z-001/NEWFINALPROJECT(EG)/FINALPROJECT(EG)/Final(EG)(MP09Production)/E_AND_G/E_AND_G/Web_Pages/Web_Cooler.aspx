<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Cooler.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_Cooler" %>
...
<center>
        <asp:Label ID="Label19" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="COOLER" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           Width="600px"></asp:Label></div></center>
            <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="COOLER" Font-Bold="True" 
               ...
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <asp:DropDownList ID="cooler_dropdown" runat="server" 
                               style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                               onselectedindexchanged="cooler_dropdown_SelectedIndexChanged">
                               <asp:ListItem>---choose brand---</asp:ListItem>
                               <asp:ListItem>Symphony</asp:ListItem>
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="cooler_dropdown" ErrorMessage="Choose Brand" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               InitialValue="---choose brand---" ValidationGroup="cooler_group"></asp:RequiredFieldValidator>
&nbsp;<br />
                       </td>
                       <td>
                           &nbsp;
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <asp:TextBox ID="txt_cooler" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           ...
                           <asp:RadioButtonList ID="cooler_rb" runat="server" RepeatDirection="Horizontal">
                       ...
                       <td>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                               ControlToValidate="cooler_rb" ErrorMessage="Select Warranty Status" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               ValidationGroup="cooler_group"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                   ...
                   <td class="style3" align="left">
                       <asp:TextBox ID="txt_cooler_des" runat="server" TextMode="MultiLine" 
