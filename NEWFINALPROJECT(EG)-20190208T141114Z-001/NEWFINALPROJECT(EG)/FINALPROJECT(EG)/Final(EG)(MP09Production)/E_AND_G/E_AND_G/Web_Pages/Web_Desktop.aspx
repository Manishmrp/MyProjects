<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Desktop.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_Desktop" %>
...
<center>
        <asp:Label ID="Label19" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="CAMCORDER" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="CAMCORDER" Font-Bold="True" 
               ...
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <asp:DropDownList ID="desktop_dropdown" runat="server" 
                               style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                               onselectedindexchanged="desktop_dropdown_SelectedIndexChanged">
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="desktop_dropdown" ErrorMessage="Select Brand" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               ValidationGroup="camcorder_group" InitialValue="---choose brand---"></asp:RequiredFieldValidator>
                           <br />
                       </td>
                       <td>
                           &nbsp;
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <asp:TextBox ID="txt_desktop" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           ...
                           <asp:RadioButtonList ID="camcorder_rb" runat="server" 
                       ...
                       <td>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                               ControlToValidate="camcorder_rb" ErrorMessage="Select Warranty Status" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               ValidationGroup="camcorder_group"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                   ...
                   <td class="style3" align="left">
                       <asp:TextBox ID="txt_desktop_des" runat="server" TextMode="MultiLine" 
                   ...
                   <td>
                       ...
                       <asp:Label ID="lblcharge" runat="server" Font-Bold="True" Font-Names="Consolas" 
                           Font-Size="Large" ForeColor="Teal" Text="600"></asp:Label>
                   </td>
                   </tr>
               </table>
               <br />
               <center>
                   <asp:Button ID="btn_repaired" runat="server" CssClass="c_sthead" 
                       ...
                       ValidationGroup="camcorder_group" />
                   <br />
                   <br />
