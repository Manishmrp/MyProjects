<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Oven.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_Oven" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <center>
        <asp:Label ID="Label6" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="OVENS" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           Width="600px"></asp:Label></div></center>
              <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="OVEN" Font-Bold="True" 
               ...
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <asp:DropDownList ID="oven_dropdown" runat="server" 
                               style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                               onselectedindexchanged="oven_dropdown_SelectedIndexChanged">
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="oven_dropdown" ErrorMessage="Choose Brand" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               InitialValue="---choose brand---" ValidationGroup="oven_group"></asp:RequiredFieldValidator>
                       </td>
                       <td>
                           &nbsp;
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <asp:TextBox ID="txt_oven" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           ...
                           <asp:RadioButtonList ID="oven_rb" runat="server" RepeatDirection="Horizontal">
                       ...
                       <td>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                               ControlToValidate="oven_rb" ErrorMessage="Select Warranty Status" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               ValidationGroup="oven_group"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                   ...
                   <td class="style3" align="left">
                       <asp:TextBox ID="txt_oven_des" runat="server" TextMode="MultiLine" 
                   ...
                   <td>
                       ...
                       <asp:Label ID="lblcharge" runat="server" Font-Bold="True" Font-Names="Consolas" 
                           Font-Size="Large" ForeColor="Teal" Text="900"></asp:Label>
                   </td>
                   </tr>
               </table>
               <br />
