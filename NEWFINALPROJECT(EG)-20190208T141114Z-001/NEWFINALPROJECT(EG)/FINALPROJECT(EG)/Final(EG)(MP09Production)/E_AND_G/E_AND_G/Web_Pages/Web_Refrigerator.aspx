<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Refrigerator.aspx.cs" Inherits="E_AND_G.Web_Refrigerator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <center><asp:Label ID="Label6" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="REFRIGERATOR" 
            Width="178px"></asp:Label></center>
</asp:Content>
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           Width="600px"></asp:Label></div></center>
            <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="REFRIGERATOR" Font-Bold="True" 
               ...
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3" align="left">
                           &nbsp;<asp:DropDownList ID="ref_dropdown" runat="server" 
                               style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                               onselectedindexchanged="ref_dropdown_SelectedIndexChanged">
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="ref_dropdown" ErrorMessage="Choose Brand" Font-Names="Arial" 
                               Font-Size="X-Small" ForeColor="Red" InitialValue="---choose brand---" 
                               ValidationGroup="ref_group"></asp:RequiredFieldValidator>
                       </td>
                       <td align="left">
                           &nbsp;
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           &nbsp;
                           <asp:TextBox ID="txt_ref" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <asp:RadioButtonList ID="ref_rb" runat="server" RepeatDirection="Horizontal">
                       ...
                       <td align="left">
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                               ControlToValidate="ref_rb" ErrorMessage="Select Warranty Status" 
                   ...
                   <td class="style3" align="left">
                       <asp:TextBox ID="txt_ref_des" runat="server" TextMode="MultiLine" 
                   ...
                   <td align="left">
                       ...
                       <asp:Label ID="lblcharge" runat="server" Font-Bold="True" Font-Names="Consolas" 
                           Font-Size="Large" ForeColor="Teal" Text="2000"></asp:Label>
                   </td>
                   </tr>
               </table>
               <br />
