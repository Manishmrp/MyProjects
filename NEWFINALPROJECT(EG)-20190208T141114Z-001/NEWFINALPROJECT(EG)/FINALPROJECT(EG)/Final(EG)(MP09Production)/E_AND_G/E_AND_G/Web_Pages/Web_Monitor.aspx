<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Monitor.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_Monitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <center>
        <asp:Label ID="Label6" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="MONITOR" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="MONITOR" Font-Bold="True" 
               ...
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <center><asp:DropDownList ID="monitor_dropdown" runat="server" 
                                   style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                                   onselectedindexchanged="monitor_dropdown_SelectedIndexChanged">
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="monitor_dropdown" ErrorMessage="Choose Brand" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               InitialValue="---choose brand---" ValidationGroup="monitor_group"></asp:RequiredFieldValidator>
                           </center>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           </td>
                       <td>
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <center><asp:TextBox ID="txt_monitor" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <center>
                               <asp:RadioButtonList ID="monitor_rb" runat="server" 
                       ...
                       <td>
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                   ControlToValidate="monitor_rb" ErrorMessage="Select Warranty Status" 
                                   Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                                   ValidationGroup="monitor_group"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                   ...
                   <td class="style3" align="left">
                       <center><asp:TextBox ID="monitor_txt" runat="server" TextMode="MultiLine" 
                   ...
                   <td>
                       ...
                       <asp:Label ID="lblcharge" runat="server" Font-Bold="True" Font-Names="Consolas" 
                           Font-Size="Large" ForeColor="Teal" Text="1250"></asp:Label>
                   </td>
                   </tr>
               </table>
               <br />
