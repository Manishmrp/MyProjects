<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Edit.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_Edit" %>
...
<asp:Content ID="Content10" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="box-shadow:0px 0px 20px 3px grey; padding:15px;">
            ...
            <center style="box-shadow:0px 0px 20px 3px grey; padding:5px; background-color:#fece44; padding:12px;">
                ...
                &nbsp;<asp:Button ID="btn_save_gender" runat="server" CssClass="btn_edit2" 
                    onclick="btn_save_gender_Click" Text="Save" ValidationGroup="gender_group_mvv" 
                    Width="90px" />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ...
                    InitialValue="---select gender---" ValidationGroup="gender_group_mvv"></asp:RequiredFieldValidator>
    ...
    <asp:View ID="View3" runat="server">
        <div style="box-shadow:0px 0px 20px 3px grey; padding:15px;">
            <center style="box-shadow:0px 0px 20px 3px grey; padding:5px; background-color:#fece44; padding:12px;">
                <asp:TextBox ID="txt_date" runat="server" CssClass="txt_c"  TextMode="Date"></asp:TextBox>
                &nbsp;<asp:Button ID="btn_save_dob" runat="server" CssClass="btn_edit2" 
                    onclick="btn_save_dob_Click" Text="Save" ValidationGroup="dob_group_mv" 
                    Width="90px" />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    ...
                    ValidationGroup="dob_group_mv"></asp:RequiredFieldValidator>
            </center>
        </div>
    </asp:View>
        ...
        <div style="box-shadow:0px 0px 20px 3px grey; padding:15px;">
            ...
            <asp:ListItem>Favourite Song?</asp:ListItem>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                    ...
                    ValidationGroup="sec_group_mv"></asp:RequiredFieldValidator>
