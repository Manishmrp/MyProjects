<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Iron.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_Iron" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <center>
        <asp:Label ID="Label6" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="IRON" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="IRON" Font-Bold="True" 
           ...
           <center>
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:DropDownList ID="iron_dropdown" runat="server" 
                                   style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                                   onselectedindexchanged="iron_dropdown_SelectedIndexChanged">
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="iron_dropdown" ErrorMessage="Choose Brand" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               InitialValue="---choose brand---" ValidationGroup="iron_group"></asp:RequiredFieldValidator>
                       </td>
                       <td>
                           &nbsp;
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:TextBox ID="txt_iron" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center>
                               <asp:RadioButtonList ID="iron_rb" runat="server" RepeatDirection="Horizontal">
                       ...
                       <td>
                           &nbsp;
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                   ControlToValidate="iron_rb" ErrorMessage="Select Warranty Status" 
                                   Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                                   ValidationGroup="iron_group"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                   ...
                   <td class="style3">
                       <center><asp:TextBox ID="txt_iron_des" runat="server" TextMode="MultiLine" 
