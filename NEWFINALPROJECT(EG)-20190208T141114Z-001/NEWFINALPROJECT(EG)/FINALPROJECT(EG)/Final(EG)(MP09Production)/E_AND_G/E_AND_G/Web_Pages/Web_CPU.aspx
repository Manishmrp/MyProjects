<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_CPU.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_CPU" %>
...
<center>
        <asp:Label ID="Label19" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="CPU" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           Width="600px"></asp:Label></div></center>
            <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="CPU" Font-Bold="True" 
           ...
           <center>
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:DropDownList ID="cpu_dropdown" runat="server" 
                                   style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                                   onselectedindexchanged="cpu_dropdown_SelectedIndexChanged">
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="cpu_dropdown" ErrorMessage="Choose Brand" Font-Names="Arial" 
                               Font-Size="X-Small" ForeColor="Red" InitialValue="---choose brand---" 
                               ValidationGroup="cpu_group"></asp:RequiredFieldValidator>
                       </td>
                       <td>
                           &nbsp;
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:TextBox ID="txt_cpu" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center>
                               <asp:RadioButtonList ID="cpu_rb" runat="server" RepeatDirection="Horizontal">
                       ...
                       <td>
                           &nbsp;
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                   ControlToValidate="cpu_rb" ErrorMessage="Select Warranty Status" 
                   ...
                   <td class="style3">
                       <center><asp:TextBox ID="txt_cpu_des" runat="server" TextMode="MultiLine" 
                   ...
                   <td>
                       ...
                       <asp:Label ID="lblcharge" runat="server" Font-Bold="True" Font-Names="Consolas" 
                           Font-Size="Large" ForeColor="Teal" Text="650"></asp:Label>
                   </td>
                   </tr>
               </table>
               <br />
