<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_CCTV.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_CCTV" %>
...
<center>
        <asp:Label ID="Label19" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="CCTV" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="CCTV" Font-Bold="True" 
           ...
           <center>
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:DropDownList ID="cctv_dropdown" runat="server" 
                                   style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                                   onselectedindexchanged="cctv_dropdown_SelectedIndexChanged">
                               <asp:ListItem>---choose-brand---</asp:ListItem>
                               <asp:ListItem>CP PLUS</asp:ListItem>
                               <asp:ListItem>iBall</asp:ListItem>
                               <asp:ListItem>Maxxlite</asp:ListItem>
                               <asp:ListItem>Citron</asp:ListItem>
                               <asp:ListItem>Other</asp:ListItem>
                           </asp:DropDownList></center>
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="cctv_dropdown" ErrorMessage="Choose Brand" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               InitialValue="---choose brand---" ValidationGroup="cctv_group"></asp:RequiredFieldValidator>
                       </td>
                       <td>
                           &nbsp;
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:TextBox ID="txt_cctv" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center>
                               <asp:RadioButtonList ID="cctv_rb" runat="server" RepeatDirection="Horizontal">
                       ...
                       <td>
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                   ControlToValidate="cctv_rb" ErrorMessage="Select Warranty Status" 
                                   Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                                   ValidationGroup="cctv_group"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                   ...
                   <td class="style3">
                       <center><asp:TextBox ID="txt_cctv_des" runat="server" TextMode="MultiLine" 
                   ...
                   <td>
                       ...
                       <asp:Label ID="lblcharge" runat="server" Font-Bold="True" Font-Names="Consolas" 
                           Font-Size="Large" ForeColor="Teal" Text="880"></asp:Label>
                   </td>
                   </tr>
               </table>
               <br />
