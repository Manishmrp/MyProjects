<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Tab.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_Tab" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <center>
        <asp:Label ID="Label6" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="TAB" 
...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentPlaceHolder6" runat="server">
    <center>
      <a href="Web_Help.aspx">  <asp:Label ID="Label8" runat="server" 
            BackColor="#20BEC9" CssClass="c_option" 
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder7" runat="server">
    <center>
        <a href="../Web_Feedback.aspx"><asp:Label ID="Label9" runat="server" 
            BackColor="#20BEC9" CssClass="c_option" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           Width="600px"></asp:Label></div></center>
            <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="TAB" Font-Bold="True" 
               ...
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <asp:DropDownList ID="tab_dropdown" runat="server" 
                               style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                               onselectedindexchanged="tab_dropdown_SelectedIndexChanged">
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="tab_dropdown" ErrorMessage="Choose Brand" Font-Names="Arial" 
                               Font-Size="X-Small" ForeColor="Red" InitialValue="---choose brand---" 
                               ValidationGroup="tab_group"></asp:RequiredFieldValidator>
                       </td>
                       <td>
                           &nbsp;
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           <asp:TextBox ID="txt_tab" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           ...
                           <asp:RadioButtonList ID="tab_rb" runat="server" RepeatDirection="Horizontal">
                       ...
                       <td>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                               ControlToValidate="tab_rb" ErrorMessage="Select Warranty Status" 
                   ...
                   <tr>
                       ...
                       <td class="style3" align="left">
                           ...
                           <asp:DropDownList ID="problem_tab_drop" runat="server" AutoPostBack="True" 
                               onselectedindexchanged="problem_tab_drop_SelectedIndexChanged">
                       ...
                       <td>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                               ControlToValidate="problem_tab_drop" ErrorMessage="Select Problem Related to" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               InitialValue="---select-problem---" ValidationGroup="tab_group"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                   ...
                   <td class="style3" align="left">
                       <asp:TextBox ID="txt_tab_des" runat="server" TextMode="MultiLine" 
                           placeholder="Optional"></asp:TextBox>
                   </td>
                   <td>
&nbsp;<asp:Label ID="Label16" runat="server" Font-Bold="True" Font-Names="Consolas" Font-Size="Small" 
                           ForeColor="Blue" Text="Charge::Rs."></asp:Label>
