...
{
    public partial class Web_Printer : System.Web.UI.Page
    {
        ...
        protected void print_dropdown_SelectedIndexChanged(object sender, EventArgs e)
        {
            string i = print_dropdown.SelectedItem.Value;
        ...
        {
            Session["brand"] = print_dropdown.SelectedValue.ToString();
            Session["model_name"] = txt_print.Text;
            Session["warranty"] = printer_rb.SelectedValue.ToString();
            Session["des_problem"] = txt_print_des.Text;
            ...
            OleDbCommand cmd = new OleDbCommand("insert into details_eg(elect_gadgets,brand_name,model_name,warranty_status,describe_problem,email) values('" + lbl_service.Text + "','" + print_dropdown.SelectedValue.ToString() + "','" + txt_print.Text + "','" + printer_rb.SelectedValue.ToString() + "','" + txt_print_des.Text + "','" + label_email.Text + "')", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
