<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Projector.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_Projector" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <center>
        <asp:Label ID="Label6" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="PROJECTOR" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="PROJECTOR" Font-Bold="True" 
           ...
           <center>
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:DropDownList ID="proj_dropdown" runat="server" 
                                   style="border:solid 2px black; border-radius:6px;">
                               ...
                               <asp:ListItem>Portronics</asp:ListItem>
                           </asp:DropDownList></center>
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                               ControlToValidate="proj_dropdown" ErrorMessage="Choose Brand" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               InitialValue="---choose brand---" ValidationGroup="proj_group"></asp:RequiredFieldValidator>
                       </td>
                       <td>
                           &nbsp;
                           <asp:Image ID="img_logo" runat="server" Height="50px" 
                               ImageUrl="~/TV_icon/blank.png" Width="50px" />
                       </td>
                   </tr>
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:TextBox ID="txt_proj" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center>
                               <asp:RadioButtonList ID="proj_rb" runat="server" RepeatDirection="Horizontal">
                       ...
                       <td>
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                   ControlToValidate="proj_rb" ErrorMessage="Select Warranty Status" 
                                   Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                                   ValidationGroup="proj_group"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                   ...
                   <td class="style3">
                       <center><asp:TextBox ID="txt_proj_des" runat="server" TextMode="MultiLine" 
                   ...
                   <td>
                       ...
                       <asp:Label ID="lblcharge" runat="server" Font-Bold="True" Font-Names="Consolas" 
                           Font-Size="Large" ForeColor="Teal" Text="550"></asp:Label>
                   </td>
                   </tr>
               </table>
               <br />
