<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Web_Xerox.aspx.cs" Inherits="E_AND_G.Web_Pages.Web_Xerox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <center>
        <asp:Label ID="Label6" runat="server" BackColor="#0899AC" CssClass="c_sthead" 
            Font-Bold="False" Font-Names="Agency FB" ForeColor="White" Text="XEROX MACHINE" 
...
<br />
   <center> <asp:Label ID="Label1" runat="server" Text="DESCRIPTION" 
           ...
           Width="600px"></asp:Label></div></center>
            <center><div>
               <asp:Label ID="lbl_service" runat="server" Text="XEROX MACHINE" Font-Bold="True" 
           ...
           <center>
               <table style="width: 100%; padding:14px; height: 240px;">
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:DropDownList ID="xerox_dropdown" runat="server" 
                                   style="border:solid 2px black; border-radius:6px;" AutoPostBack="True" 
                                   onselectedindexchanged="xerox_dropdown_SelectedIndexChanged">
                               ...
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                   ControlToValidate="xerox_dropdown" ErrorMessage="Select Brand" 
                                   Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                                   InitialValue="---choose brand---" ValidationGroup="xerox_grp"></asp:RequiredFieldValidator>
                           </center>
&nbsp;</td>
                       <td>
                           &nbsp;
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center><asp:TextBox ID="txt_xerox" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style3">
                           <center>
                               <asp:RadioButtonList ID="xerox_rb" runat="server" RepeatDirection="Horizontal">
                       ...
                       <td>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                               ControlToValidate="xerox_rb" ErrorMessage="Select Warranty Status" 
                               Font-Names="Arial" Font-Size="X-Small" ForeColor="Red" 
                               ValidationGroup="xerox_grp"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                   ...
                   <td class="style3">
                       <center><asp:TextBox ID="txt_xerox_des" runat="server" TextMode="MultiLine" 
                   ...
                   <td>
                       ...
                       <asp:Label ID="lblcharge" runat="server" Font-Bold="True" Font-Names="Consolas" 
                           Font-Size="Large" ForeColor="Teal" Text="500"></asp:Label>
                   </td>
                   </tr>
               </table>
               <br />
